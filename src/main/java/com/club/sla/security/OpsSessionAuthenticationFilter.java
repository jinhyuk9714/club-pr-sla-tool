...
import com.club.sla.ops.OpsAuthenticatedSession;
...
@Component
public class OpsSessionAuthenticationFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(
    ...
    if (request.getSession(false) != null) {
      ...
      if (authenticatedSession instanceof OpsAuthenticatedSession opsAuthenticatedSession) {
        mergeAuthentication(opsAuthenticatedSession, "ROLE_OPS_USER");
      }
    }
